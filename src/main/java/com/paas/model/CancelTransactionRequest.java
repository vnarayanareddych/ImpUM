...
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2018-10-11T17:06:08.381+05:30")
...
public class CancelTransactionRequest {
	...
	private String cancelReasonDescription = null;
	...
	public CancelTransactionRequest txnRefNo(String txnRefNo) {
	...
	public CancelTransactionRequest partnerTxnRefNo(String partnerTxnRefNo) {
	...
	public CancelTransactionRequest requiresAuthorization(Integer requiresAuthorization) {
	...
	public CancelTransactionRequest serviceType(String serviceType) {
	...
	public CancelTransactionRequest productType(String productType) {
	...
	public CancelTransactionRequest cancelReasonCode(Integer cancelReasonCode) {
	...
	public CancelTransactionRequest cancelReasonDescription(String cancelReasonDescription) {
		this.cancelReasonDescription = cancelReasonDescription;
		return this;
	}

	/**
	 * Get cancelReasonDescription
	 * 
	...
	public CancelTransactionRequest cancelFlag(Integer cancelFlag) {
	...
	public CancelTransactionRequest controlFlag(Integer controlFlag) {
	...
	public CancelTransactionRequest reservedParam1(String reservedParam1) {
	...
	public CancelTransactionRequest reservedParam2(String reservedParam2) {
	...
	public CancelTransactionRequest reservedParam3(String reservedParam3) {
	...
	public CancelTransactionRequest reservedParam4(String reservedParam4) {
	...
	public CancelTransactionRequest reservedParam5(String reservedParam5) {
	...
	public CancelTransactionRequest reservedParam6(String reservedParam6) {
	...
	public CancelTransactionRequest reservedParam7(String reservedParam7) {
	...
	public CancelTransactionRequest reservedParam8(String reservedParam8) {
	...
	public CancelTransactionRequest reservedParam9(String reservedParam9) {
	...
	public CancelTransactionRequest reservedParam10(String reservedParam10) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.txnRefNo, cancelTransactionRequest.txnRefNo)
				&& Objects.equals(this.partnerTxnRefNo, cancelTransactionRequest.partnerTxnRefNo)
				&& Objects.equals(this.requiresAuthorization, cancelTransactionRequest.requiresAuthorization)
				&& Objects.equals(this.serviceType, cancelTransactionRequest.serviceType)
				&& Objects.equals(this.productType, cancelTransactionRequest.productType)
				&& Objects.equals(this.cancelReasonCode, cancelTransactionRequest.cancelReasonCode)
				&& Objects.equals(this.cancelReasonDescription, cancelTransactionRequest.cancelReasonDescription)
				&& Objects.equals(this.cancelFlag, cancelTransactionRequest.cancelFlag)
				&& Objects.equals(this.controlFlag, cancelTransactionRequest.controlFlag)
				&& Objects.equals(this.reservedParam1, cancelTransactionRequest.reservedParam1)
				&& Objects.equals(this.reservedParam2, cancelTransactionRequest.reservedParam2)
				&& Objects.equals(this.reservedParam3, cancelTransactionRequest.reservedParam3)
				&& Objects.equals(this.reservedParam4, cancelTransactionRequest.reservedParam4)
				&& Objects.equals(this.reservedParam5, cancelTransactionRequest.reservedParam5)
				&& Objects.equals(this.reservedParam6, cancelTransactionRequest.reservedParam6)
				&& Objects.equals(this.reservedParam7, cancelTransactionRequest.reservedParam7)
				&& Objects.equals(this.reservedParam8, cancelTransactionRequest.reservedParam8)
				&& Objects.equals(this.reservedParam9, cancelTransactionRequest.reservedParam9)
				&& Objects.equals(this.reservedParam10, cancelTransactionRequest.reservedParam10);
	}

	@Override
	public int hashCode() {
		return Objects.hash(txnRefNo, partnerTxnRefNo, requiresAuthorization, serviceType, productType,
				cancelReasonCode, cancelReasonDescription, cancelFlag, controlFlag, reservedParam1, reservedParam2,
				reservedParam3, reservedParam4, reservedParam5, reservedParam6, reservedParam7, reservedParam8,
				reservedParam9, reservedParam10);
	}
	...
	public String toString() {
		...
		sb.append("    cancelReasonDescription: ").append(toIndentedString(cancelReasonDescription)).append("\n");
